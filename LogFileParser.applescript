...
on debug()
	...
	script theTexDocObj
		property logFileRef : alias ("IGAGURI HD:Users:tkurita:WareHouse:Study:‰Á‘¬Ší:CT:CT.log" as Unicode text)
		property texBasePath : "IGAGURI HD:Users:tkurita:WareHouse:Study:‰Á‘¬Ší:CT:CT" as Unicode text
	end script
	activate
