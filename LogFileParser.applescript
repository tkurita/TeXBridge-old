...
on debug()
	...
	script theTexDocObj
		property logFileRef : alias ("IGAGURI HD:Users:tkurita:WareHouse:Study:êßå‰:ì`íBä÷êî:transferfunction.log" as Unicode text)
		property texBasePath : "IGAGURI HD:Users:tkurita:WareHouse:Study:êßå‰:ì`íBä÷êî:transferfunction" as Unicode text
	end script
	activate
